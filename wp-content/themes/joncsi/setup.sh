...
# Defaults
default_name="Jaywon Nein CSI"
default_id="joncsi"
default_author="Briantics, Inc."
default_author_url="https://briantics.com"
default_url="joncsi.test"
default_namespace="Briantics\Joncsi"
